...
/// Helper extensions for [PaymentTerm] display properties.
extension PaymentTermX on PaymentTerm {
  String get label => switch (this) {
    PaymentTerm.contado => 'Contado',
    PaymentTerm.credito => 'Crédito',
  };

  StatusType get badgeType => switch (this) {
    PaymentTerm.contado => StatusType.success,
    PaymentTerm.credito => StatusType.info,
  };
}
